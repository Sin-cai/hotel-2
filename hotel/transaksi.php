    ...
    <div class="full">
        <div class="containerT content w-full">
            ...
            <table class="data-table" border="1" cellpadding="5">
                ...
                <?php
            include "koneksi.php";
            $data = mysqli_query($koneksi, "SELECT transaksi.*,userr.username,userr.NIK,reserfasi.harga FROM transaksi LEFT JOIN reserfasi ON transaksi.id_rs=reserfasi.id_rs LEFT JOIN userr ON reserfasi.id_user=userr.id_user ");
