...
if(isset($_GET['id'])) {
    $id_RS = $_GET['id'];
    $result = mysqli_query($koneksi, "SELECT transaksi.*,reserfasi.*,bed.*,kamar.* FROM transaksi left join reserfasi on transaksi.id_rs=reserfasi.id_rs left join bed on bed.id_bed=reserfasi.id_bed left join kamar on kamar.roomID=reserfasi.roomID WHERE id_transaksi='$id_RS'");
    ...
    $date2 = strtotime($reservation['chek_out']);

    // Calculate the difference in days
    $days = $reservation['stay'];
...
<body>
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="item">
                <td>TYPE Room: <?php echo $reservation['type'] ?></td>
            ...
            <tr class="item last">
                ...
                <td><?php echo $reservation['chek_out'] ?></td>
            </tr>

            <tr class="item last">
                <td>No Room(s) Booked:</td>

                <td><?php echo $reservation['nomor_kamar'] ?></td>
            </tr>
            <tr class="item last">
                <td>Stay: </td>
        ...
        <a href="../admin/zenadmin.php"><button>Back to Previous Page</button></a>
