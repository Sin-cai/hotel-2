...
<head>
    <link rel="stylesheet" href="./admin/inputs.css">
</head>
...
<body>
    <div>
        ...
        include 'koneksi.php';
        $id_T = $_GET['idt'];
        $data_barang = mysqli_query($koneksi, "SELECT transaksi.*,userr.username,reserfasi.harga FROM transaksi LEFT JOIN reserfasi ON transaksi.id_rs=reserfasi.id_rs LEFT JOIN userr ON reserfasi.id_user=userr.id_user where id_transaksi='$id_T'");
        ...
        <form method="post" action="aksi_transaksi.php">
            <table>
                ...
                <tr>
                    <td>harga</td>
                    <td><input id="harga" type="number" name="harga" value="<?php echo $tampil['harga']; ?>" readonly>
                    </td>
                </tr>
                <tr>
                    <td>membayar</td>
                ...
                <tr>
                    ...
                    <td><a class="view-siswa-button" href="../reserfasi/table_chekin.php">Lihat Transaksi</a></td>
                </tr>
            </table>
        </form>
        <?php
